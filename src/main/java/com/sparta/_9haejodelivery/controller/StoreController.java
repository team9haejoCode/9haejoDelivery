...
public class StoreController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<StoreResponseDto>> createStore(@Valid @RequestBody StoreRequestDto requestDto) {
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(HttpStatus.CREATED, "매장 등록 성공", storeService.createStore(requestDto)));
    }
    ...
    public ResponseEntity<ApiResponse<StoreResponseDto>> updateStore(
        ...
        return ResponseEntity.ok(ApiResponse.success(HttpStatus.OK, "매장 수정 성공", storeService.updateStore(storeId, requestDto)));
    }
